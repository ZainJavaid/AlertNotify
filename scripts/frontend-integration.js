 ...
 * This file demonstrates how to integrate Alertnotifychain with a web frontend
 */

// For React/Vue/Angular applications
export class AlertnotifychainClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new AlertnotifychainClient(provider, contractAddress);
